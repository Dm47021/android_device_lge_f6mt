...
char const*const    LED_LOCK_UPDATE_FILE = "/sys/class/leds/led:rgb_red/device/lock";

char const*const    PMIC_KPJT_BLINK_FILE = "/sys/class/pmic-kpjt/make_patterns/blink_patterns";
char const*const    PMIC_KPJT_PATTERN_FILE = "/sys/class/pmic-kpjt/make_patterns/test_patterns";
char const*const    PMIC_KPJT_TEST_FILE = "/sys/class/pmic-kpjt/use_patterns/setting";
